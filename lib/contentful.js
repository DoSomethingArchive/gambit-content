 ...
 * @return {Promise}
 */
module.exports.fetchDefaultAndOverrideCampaignsForCampaignId = function (campaignId) {
  return new Promise((resolve, reject) => {
    logger.debug(`contentful.fetchDefaultAndOverrideCampaignsForCampaignId:${campaignId}`);
