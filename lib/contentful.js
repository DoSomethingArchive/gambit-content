...
module.exports.renderAllMessagesForPhoenixCampaign = function (phoenixCampaign) {
  ...
  return new Promise((resolve, reject) =>
    ...
    exports.getAllFieldsForCampaign(phoenixCampaign.id)
      .then((campaignFields) => { // eslint-disable-line arrow-body-style
        /**
         * Use Promise.map to create an array of promises to wait on,
         * replacing the push->forEach->Promise.all boilerplate
         */
        return Promise.map(
          /**
           * Iterator
