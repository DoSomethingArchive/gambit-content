...
module.exports = {
   ...
   * @return {Promise}
   */
  saveDraftPhotoFromReq: function saveDraftPhotoFromReq(req) {
   ...
   * @return {Promise}
   */
  saveDraftQuantityFromReq: function saveDraftQuantityFromReq(req) {
    logger.verbose('saveDraftQuantityFromReq');
    req.draftSubmission.quantity = Number(requestHelper.getMessageText(req));
    return req.draftSubmission.save();
  },
  /**
   * @param {Object} req
