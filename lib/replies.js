...
module.exports.askStart = function askStart(req, res) {
  return sendResponse('botSignupConfirmed', req, res);
};

module.exports.invalidStart = function invalidStart(req, res) {
  return sendResponse('botSignupConfirmedAutoReply', req, res);
};
