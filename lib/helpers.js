...
/**
 * Checks if string should be censored.
 * TODO: This function was only used in DonorsChooseBot, we are still not clear if
 * it should be used in Gambit.
 * Issue: https://github.com/DoSomething/gambit/issues/895
 *
 * @param  {string} stringToBeCensored
 * @return {boolean}
 */
module.exports.containsNaughtyWords = function (stringToBeCensored) {
  const naughtyWords = config.naughtyWords;
