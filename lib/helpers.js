...
module.exports.handlePhoenixPostError = function handlePhoenixPostError(req, res, err) {
  if (err.message.includes('API response is false')) {
    return module.exports.endConversationWithError(req, res, err);
  }
 ...
 */
module.exports.continueConversationWithMessageType = function continueConversationWithMessageType(
  req, res, messageType) {
  let replyMessage;

  return module.exports.renderMessageForMessageType(req, messageType)
    .then((message) => {
    ...
    .then(() => {
      ...
      return module.exports.sendResponse(res, 200, replyMessage);
    })
 ...
 */
module.exports.endConversationWithError = function endConversationWithError(req, res, error) {
  ...
  return module.exports.renderMessageForMessageType(req, messageType)
    .then((message) => {
      ...
      return module.exports.sendErrorResponse(res, error);
    })
    .catch(err => module.exports.sendErrorResponse(res, err));
};
 ...
 */
module.exports.endConversationWithMessage = function endConversationWithMessage(req, res, message) {
  // todo: Promisify this POST request and only send back Gambit 200 on profile_update success.
  req.user.postMobileCommonsProfileUpdate(process.env.MOBILECOMMONS_OIP_AGENTVIEW, message);

  return module.exports.sendResponse(res, 200, message);
};
 ...
 */
module.exports.endConversationWithMessageType = function endConversationWithMessageType(
  req, res, messageType) {
  return module.exports.renderMessageForMessageType(req, messageType)
    .then((message) => {
      ...
      return module.exports.endConversationWithMessage(req, res, message);
    })
    .catch(err => module.exports.sendErrorResponse(res, err));
};
 ...
 */
module.exports.trackUserMessageInDashbot = function trackUserMessageInDashbot(req) {
  if (req.retryCount && req.retryCount >= 1) {
    logger.info(`This is a retry request. Retry count: ${req.retryCount}`);
    return;
  }
