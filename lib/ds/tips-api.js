 ...
 */
exports.deliverTips = function(request, response) {
  if (typeof(request.query.mdata_id) === 'undefined') {
    response.send(204);
    return;
  }
  ...
  var mdataId = parseInt(request.query.mdata_id);
